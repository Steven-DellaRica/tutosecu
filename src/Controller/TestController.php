...
class TestsController extends AbstractController
{
    ...
    public function validationTests(Request $request){
        ...
        if($json){
            ...
            $test = new Test();
            $test->setTestTitle(UtilsService::cleanInput($data['title']));
            $test->setTestDate(new \DateTimeImmutable(UtilsService::cleanInput($data['date'])));
            $test->setTestStatut((boolean)UtilsService::cleanInput($data['statut']));
